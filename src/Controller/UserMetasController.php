...
class UserMetasController extends AppController
{
    ...
    public function add()
    {
        ...
        if ($this->request->is('post')) {
            ...
            if ($this->UserMetas->save($userMeta)) {
                $this->Flash->success('The user meta has been saved.');
                return $this->redirect(['action' => 'index']);
            } else {
                $this->Flash->error('The user meta could not be saved. Please, try again.');
            }
        }
    ...
    public function delete($id = null)
    {
        ...
        if ($this->UserMetas->delete($userMeta)) {
            $this->Flash->success('The user meta has been deleted.');
        } else {
            $this->Flash->error('The user meta could not be deleted. Please, try again.');
        }
        return $this->redirect(['action' => 'index']);
    }
}
